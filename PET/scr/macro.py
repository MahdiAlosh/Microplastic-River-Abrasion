...
files = [
    os.path.join(script_dir, 'sinks_EU_Clothing (product sector)_PET_Surface water (macro).csv'),
    os.path.join(script_dir,'sinks_EU_Household textiles (product sector)_PET_Surface water (macro).csv'),
    os.path.join(script_dir,'sinks_EU_Packaging_PET_Surface water (macro).csv'),
    os.path.join(script_dir,'sinks_EU_Technical textiles_PET_Surface water (macro).csv'),
]
