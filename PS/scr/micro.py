...
files = [
    os.path.join(script_dir,'sinks_EU_Agriculture_PS_Surface water (micro).csv'),
    os.path.join(script_dir,'sinks_EU_Domestic primary plastic production_PS_Surface water (micro).csv'),
    os.path.join(script_dir,'sinks_EU_Import of primary plastics_PS_Surface water (micro).csv'),
    os.path.join(script_dir,'sinks_EU_Packaging_PS_Surface water (micro).csv')
]
