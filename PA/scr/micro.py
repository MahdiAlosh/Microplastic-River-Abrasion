...
files = [
    os.path.join(script_dir, 'sinks_EU_Clothing (product sector)_PA_Surface water (micro).csv'),
    os.path.join(script_dir, 'sinks_EU_Domestic primary plastic production_PA_Surface water (micro).csv'),
    os.path.join(script_dir, 'sinks_EU_Household textiles (product sector)_PA_Surface water (micro).csv'),
    os.path.join(script_dir, 'sinks_EU_Import of primary plastics_PA_Surface water (micro).csv'),
    os.path.join(script_dir, 'sinks_EU_Intentionally produced microparticles_PA_Surface water (micro).csv')
]
